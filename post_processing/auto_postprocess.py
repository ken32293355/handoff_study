...
#what it will do:
#1. group files in directory (example directory: 0121) into several groups according to different interval time
...
for cell_name in cell_names:
    ...
    for file in files:
        ...
        time = dt.datetime.utcfromtimestamp(os.path.getmtime(dir_name + "/" + store_cell_name + file)) + dt.timedelta(hours=8)
        print(file, time)
