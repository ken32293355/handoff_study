...
tcpdumpfile = r"C:\Users\USER\Desktop\0122\xm2\22-01-22-17-27-31.pcap"
...
for ts, buf in pcap:
    ...
    if (len(eth.data) - 32) % 250  == 0 and buf[32:36] == b'\x8cp\x14\xb7':    # We set the payload length to be 250 in iperf, so here we set the length checking to be 250 + (20+8)
        duplicate_num = (len(eth.data) - 32) // 250
